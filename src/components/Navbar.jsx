...
const Navbar = () => (
  <div>
    ...
    <div className={`flex py-[56px] max-w-[80%] mx-[auto] z-1 `}>
      <div class="flex">
        ...
        <div>
          <button className="bg-white rounded-[72px] float-right text-[#373737] font-bold px-[30px] py-[28px] text-[18px] flex">
            Booking Now
          </button>
        </div>
      </div>
